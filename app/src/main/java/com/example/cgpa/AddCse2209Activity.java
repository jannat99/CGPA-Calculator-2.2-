...
public class AddCse2209Activity extends AppCompatActivity {

    SharedPreferences sharedPreferences;

    String num;
    String item = "CSE 2209";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sharedPreferences = getSharedPreferences("SaveData4", Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPreferences.edit();
                // editor.putString("courseName", courseName);
                editor.putString("Course4", item);
                editor.putString("Total4", Total);
                editor.putString("Grades4",num);
                editor.apply();
            }
        });
        ...
        viewBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AddCse2209Activity.this, view.class));
            }
        });
