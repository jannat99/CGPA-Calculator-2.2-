...
public class AddCse2203Activity extends AppCompatActivity {

    SharedPreferences sharedPreferences;

    String num;
    String item = "CSE 2203";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_cse2203);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("Course2", item);
                editor.putString("Total2", Total);
                editor.putString("Grades2",num);
                editor.apply();
            }
        });
        ...
        viewBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AddCse2203Activity.this, view.class));
            }
        });
