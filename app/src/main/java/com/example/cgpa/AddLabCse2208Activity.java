...
public class AddLabCse2208Activity extends AppCompatActivity {
    ...
    TextView shtotal;
    String num;
    String item = "CSE 2208";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_lab_cse2208);
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sharedPreferences = getSharedPreferences("SaveData03", Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPreferences.edit();
                // editor.putString("courseName", courseName);
                editor.putString("Courses03", item);
                editor.putString("Totals03", Total);
                editor.putString("GradesLab03",num);
                editor.apply();
            }
        });
        ...
        viewBn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AddLabCse2208Activity.this , view.class));
            }
        });
