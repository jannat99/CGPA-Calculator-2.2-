...
public class AddLabCse2210Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sharedPreferences = getSharedPreferences("SaveData04", Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPreferences.edit();
                // editor.putString("courseName", courseName);
                editor.putString("Courses04", item);
                editor.putString("Totals04", Total);
                editor.putString("GradesLab04",num);
                editor.apply();
            }
        });
        ...
        viewBn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AddLabCse2210Activity.this , view.class));
            }
        });
