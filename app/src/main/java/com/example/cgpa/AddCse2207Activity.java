...
public class AddCse2207Activity extends AppCompatActivity {

    SharedPreferences sharedPreferences;

    String num;
    String item = "CSE 2207";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("Course3", item);
                editor.putString("Total3", Total);
                editor.putString("Grades3",num);
                editor.apply();
            }
        });
        ...
        viewBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AddCse2207Activity.this, view.class));
            }
        });
