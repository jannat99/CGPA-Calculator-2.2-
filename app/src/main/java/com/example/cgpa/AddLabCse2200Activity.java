...
public class AddLabCse2200Activity extends AppCompatActivity {
    ...
    TextView shtotal;
    String num;
    String item = "CSE 2200";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_lab_cse2200);
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sharedPreferences = getSharedPreferences("SaveData01", Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPreferences.edit();
                // editor.putString("courseName", courseName);
                editor.putString("Courses01", item);
                editor.putString("Totals01", Total);
                editor.putString("GradesLab01",num);
                editor.apply();
            }
        });
        ...
        viewBn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AddLabCse2200Activity.this , view.class));
            }
        });
