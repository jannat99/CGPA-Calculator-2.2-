...
public class AddLabCse2202Activity extends AppCompatActivity {
    ...
    TextView shtotal;
    String num;
    String item = "CSE 2202";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_lab_cse2202);
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sharedPreferences = getSharedPreferences("SaveData02", Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPreferences.edit();
                // editor.putString("courseName", courseName);
                editor.putString("Courses02", item);
                editor.putString("Totals02", Total);
                editor.putString("GradesLab02",num);
                editor.apply();
            }
        });
        ...
        viewBn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AddLabCse2202Activity.this , view.class));
            }
        });
