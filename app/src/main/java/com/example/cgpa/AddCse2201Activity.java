...
public class AddCse2201Activity extends AppCompatActivity {

    SharedPreferences sharedPreferences;

    String num;
    String item = "CSE 2201";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_cse2201);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("Course1", item);
                editor.putString("Total1", Total);
                editor.putString("Grades1",num);
                editor.apply();
            }
        });
        ...
        viewBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AddCse2201Activity.this, view.class));
            }
        });
